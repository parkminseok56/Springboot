...
<table id="list">
  ...
  <tr>
      ...
      <textarea name="content" rows="8" cols="70" >${productVO.content}</textarea></td>
  </tr>
  <tr>
       <th>상품이미지</th> 
           <td width="343" colspan="5" stlye="vertical=align:top;">
      현재 이미지 : <img src="product_images/${productVO.image}" width="200px;"><br>
