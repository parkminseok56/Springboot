...
<form id="join" action="join" method="post" name="formm">
	...
	<fieldset>
       ...
       <!--  <label>Zip Code</label><input type="text" name="zip_num"   size="10" >      
        ...
        <input type="button"  class="dup" onclick="sample6_execDaumPostcode()" value="우편 번호 찾기"><br>
        <label>Address</label>
        <input type="text" id="sample6_address" name="address1"  value="${dto.address1 }" size="50" readonly    ><br>
        <label>detailAddress</label>
        <input type="text" id="sample6_detailAddress" name="address2"  value="${dto.address2 }" size="50"    ><br>
        <label>extraAddress</label>
        <input type="text" id="sample6_extraAddress" name="address3"  value="${dto.address3 }"  readonly    ><br>
